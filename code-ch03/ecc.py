...
class Point:
    ...
    # tag::source3[]
    # This method is using `binary expansion` technique to calculate
    # the scalar multiplication of a point and can deal with very
    # large coefficients
    def __rmul__(self, coefficient):
        coef = coefficient
        current = self  # <1>
...
class ECCTest(TestCase):
    ...
    def test_add(self):
        ...
        for addition in additions:
            x1_raw, y1_raw, x2_raw, y2_raw, x3_raw, y3_raw = addition
